...
\begin{outerlist}
    \item \href{https://github.com/junbuluv/paper-drafts/blob/main/specialization.pdf}{Private Information, Private Expertise, and Lender Specialization} \hfill \textit{Under Review}
    \item \href{https://github.com/junbuluv/paper-drafts/blob/main/discretion.pdf}{Rules, Discretion, and Soft Information in Small Business Lending} \hfill \textit{Work in Progress}
\end{outerlist}
